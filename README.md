...
└── md
    ...
    │   ├── Android 逆向之旅 --- 基于对 so 中的 section 加密技术实现 so 加固.md
    │   ├── Android 逆向之旅 ---SO(ELF) 文件格式详解.md
    │   ├── Android 系统推送 Hook 实战.md
    │   ├── Android 逆向中的各种 tracer.md
    │   ├── Android 操作系统架构开篇 - Gityuan 博客 | 袁辉辉的技术博客.md
    │   ├── Android 调试实战与原理详解.md
    │   ├── ELF 文件及 android hook 原理 - 腾讯云开发者社区 - 腾讯云.md
    ...
    ├── Android QQ NT 版数据库解密 | yllhwa's blog.md
    ├── Binder 系列—开篇 - Gityuan 博客 | 袁辉辉的技术博客.md
    ...
    │   ├── FRIDA-API 使用篇：Java、Interceptor、NativePointer(Function.md
    │   ├── FRIDA-API 使用篇：rpc、Process、Module、Memory 使用方法及示例 - 安全客 - 安全资讯平台.md
    │   ├── Frida Android hook.md
    │   ├── Frida 的 Stalker · 逆向调试利器：Frida.md
    │   ├── Frida 中的 Stalker(1) - 简书.md
    │   ├── Frida 教程，rpc、Process、Module、Memory 使用方法及示例.md
    ...
    │   ├── Solving CTF with Frida - Part 1.md
    │   ├── Solving CTF with Frida - Part 2.md
    │   ├── Solving CTF with Frida - Part 3.md
    │   ├── Solving CTF with Frida - Part 4.md
    │   ├── Solving CTF with Frida - Part 5.md
    │   ├── Solving CTF with Frida - Part 6.md
    ...
    │   ├── Cesar Rodriguez | Personal blog.md
    ...
    ├── windows 取证之导出微信 & QQ 聊天记录 - SAUCERMAN.md
    ├── wx 支付流程以及加密的分析.md
